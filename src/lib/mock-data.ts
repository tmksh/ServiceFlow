import type { Case, CaseStatus, LineMessage, Settlement, Notification, Platform, LP, CalendarGroup } from "@/types";
...
export const CALENDAR_GROUPS: CalendarGroup[] = [
  {
    ...
    isPinned: true,
    members: [
      { id: "m1", name: "田中",  avatar: "田", color: "#6366f1", role: "owner"  },
      { id: "m2", name: "佐藤",  avatar: "佐", color: "#8b5cf6", role: "editor" },
      { id: "m3", name: "鈴木",  avatar: "鈴", color: "#06b6d4", role: "editor" },
      { id: "m4", name: "高橋",  avatar: "高", color: "#f59e0b", role: "viewer" },
      { id: "m5", name: "渡辺",  avatar: "渡", color: "#10b981", role: "viewer" },
      { id: "m6", name: "新",    avatar: "新", color: "#ef4444", role: "viewer" },
      { id: "m7", name: "吉",    avatar: "吉", color: "#3b82f6", role: "viewer" },
    ],
    caseFilter: { prefs: ["神奈川県"] },
  },
  {
    id: "cg-tokyo",
    name: "不用品回収　チーム東京",
    description: "東京都エリア担当チーム",
    color: "#6366f1",
    coverEmoji: "🏙️",
    area: "東京",
    category: "fuyouhin",
    ...
    members: [
      { id: "m1", name: "田中",  avatar: "田", color: "#6366f1", role: "owner"  },
      { id: "m8", name: "伊藤",  avatar: "伊", color: "#8b5cf6", role: "editor" },
      { id: "m9", name: "山本",  avatar: "山", color: "#06b6d4", role: "viewer" },
    ],
    caseFilter: { prefs: ["東京都"] },
  },
  {
    id: "cg-kansai-hikkoshi",
    name: "関西スマコレ〜片付けじゃけえ〜",
    description: "関西エリア 引っ越し・片付け専門",
    color: "#f59e0b",
    coverEmoji: "📦",
    area: "関西",
    category: "hikkoshi",
    ...
    isPinned: false,
    members: [
      { id: "m10", name: "越",   avatar: "越", color: "#f59e0b", role: "owner"  },
      { id: "m11", name: "ε",   avatar: "ε",  color: "#10b981", role: "editor" },
      { id: "m12", name: "中",   avatar: "中", color: "#ef4444", role: "viewer" },
    ],
    caseFilter: { prefs: ["大阪府", "京都府", "兵庫県"] },
  },
  {
    id: "cg-cleaning-kanto",
    name: "Susanoo ハウスクリーニング",
    description: "関東エリアのハウスクリーニング",
    color: "#06b6d4",
    coverEmoji: "🏠",
    area: "関東",
    category: "cleaning",
    ...
    isPinned: false,
    members: [
      { id: "m3",  name: "鈴木",  avatar: "鈴", color: "#06b6d4", role: "owner"  },
      { id: "m13", name: "吉",    avatar: "吉", color: "#6366f1", role: "editor" },
      { id: "m14", name: "k",     avatar: "k",  color: "#8b5cf6", role: "editor" },
      { id: "m15", name: "宮",    avatar: "宮", color: "#f59e0b", role: "viewer" },
    ],
    caseFilter: { prefs: ["東京都", "神奈川県", "埼玉県", "千葉県"] },
  },
  {
    id: "cg-fukuoka",
    name: "不用品回収　チーム福岡",
    description: "福岡・九州エリア担当",
    color: "#ef4444",
    coverEmoji: "🌊",
    area: "福岡",
    category: "fuyouhin",
    ...
    isPinned: false,
    members: [
      { id: "m16", name: "山",    avatar: "山", color: "#ef4444", role: "owner"  },
      { id: "m17", name: "新",    avatar: "新", color: "#6366f1", role: "editor" },
      { id: "m18", name: "下",    avatar: "下", color: "#8b5cf6", role: "viewer" },
      { id: "m19", name: "菜",    avatar: "菜", color: "#06b6d4", role: "viewer" },
      { id: "m13", name: "吉",    avatar: "吉", color: "#f59e0b", role: "viewer" },
    ],
    caseFilter: { prefs: ["福岡県"] },
  },
  {
    id: "cg-shift-kanto",
    name: "Susanoo 関東 シフト",
    description: "関東エリアのシフト管理",
    color: "#8b5cf6",
    coverEmoji: "📅",
    area: "関東",
    category: "all",
    ...
    members: [
      { id: "m1",  name: "田中",  avatar: "田", color: "#6366f1", role: "owner"  },
      { id: "m2",  name: "佐藤",  avatar: "佐", color: "#8b5cf6", role: "editor" },
      { id: "m15", name: "宮",    avatar: "宮", color: "#f59e0b", role: "editor" },
    ],
    caseFilter: { prefs: ["東京都", "神奈川県", "埼玉県", "千葉県"] },
  },
];
